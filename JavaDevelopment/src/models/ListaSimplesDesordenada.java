...
/**
 *  Implementação de uma ListaSimplesDesordenada genérica utilizando ponteiros
 * @author Gabriel Villar Scalese, Vicente Pinto Tomás Junior, Vitor Mugnol Estevam de Araujo.
 * @param <X> Recebe o tipo o qual a ListaSimplesDesordenada guardará
 * @since 2020
 */
 ...
 */
	 ...
	 * uma ListaSimplesDesordenada com conteúdo idêntico ao da instância à qual
    ...
    /**
     * Busca na ListaSimplesDesordenada o dado passado.Caso encontre retorna true,caso contrário false.
     * @param i O dado que se deseja buscar na ListaSimplesDesordenada
     * @return true caso exista o dado na ListaSimplesDesordenada e false caso contrário
    ...
    /**
	 * Produz uma cópia fiel de uma ListaSimplesDesordenada.
	 * Produz e resulta uma cópia exata da ListaSimplesDesordenada à qual o método for aplicado.
    ...
    /**
   	 * Constroi uma nova instância da classe ListaSimplesDesordenada.
   	 * Para tanto, deve ser fornecida uma ListaSimplesDesordenada que servirá como
   	 * modelo.
    ...
    /**
    * Constrói uma nova instância da classe ListaSimplesDesordenada
    */
     ...
     * @return o elemento no início da ListaSimplesDesordenada
     * @throws Exception caso a ListaSimplesDesordenada esteja vazia
     */
    ...
    /**
     * Checa se a ListaSimplesDesordenada está vazia retornando true em caso positivo e false em caso negativo
     * @return true caso não hajam elementos na ListaSimplesDesordenada e false em caso contrário
     */
    ...
    /**
     * Retorna uma cópia do elemento da ListaSimplesDesordenada que foi passado como parâmetro
